...
v = VideoWriter('D:/CFD/MATLAB/lorenz_attractor12.avi'); % Name of the video file
v.FrameRate = 200; % Frame rate of the video
open(v);
...
for i = 2:length(t)
    ...
    view(3 + angle, 30); % Adjust the second parameter for vertical angle
